...
#create a deck instance called mydeck
mydeck = Deck()

#create a crad called mycard
mycard = Card("Hearts","10")

#now try to change the card to invalid properties
print ("\n  Attempting mycard.suit = 'Aces'")
mycard.suit = "Aces"
print ("\n  Attempting mycard.number = '13'")
mycard.number = "13"
